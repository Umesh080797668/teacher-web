...
export default function AdminDashboardPage() {
  ...
  const handleCreateTeacher = async () => {
    ...
    try {
      const teacherData = {
        ...
        // Don't send companyId - will be added when teacher scans QR
      };

      await teachersApi.create(teacherData);
      toast.success('Teacher created successfully. They will be added to your company when they scan your QR code.');
  ...
  const handleGenerateQR = async () => {
    try {
      ...
      // QR code is already generated by backend
