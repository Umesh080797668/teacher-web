              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Default theme</p>
                  </button>
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Dark theme</p>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{APP_NAME}</span>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full text-left px-4 py-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition flex items-center justify-between"
              >
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start">
                  <svg className="w-6 h-6 mr-3 text-indigo-600 dark:text-indigo-400 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <div>
                    <p className="font-semibold text-sm text-gray-700 dark:text-gray-300">Email</p>
                    <p className="text-gray-900 dark:text-white">support@eduverse.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <p className="font-semibold text-sm text-gray-700 dark:text-gray-300">Website</p>
                    <p className="text-gray-900 dark:text-white">www.eduverse.com/support</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">Monday - Friday: 9:00 AM - 6:00 PM</p>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Saturday: 10:00 AM - 4:00 PM</p>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Sunday: Closed</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Data Retention</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 mt-6 pt-4">
                ...
                <a 
                  ...
                  className="text-xs text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-700 dark:hover:text-indigo-300"
                >
