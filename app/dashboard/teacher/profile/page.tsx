              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 dark:text-white py-2">{teacher?.phone || '-'}</p>
                  )}
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Teacher ID</label>
                  <p className="text-gray-900 dark:text-white py-2 font-mono bg-gray-50 dark:bg-gray-700 px-3 rounded-lg">{teacher?.teacherId || '-'}</p>
                </div>
